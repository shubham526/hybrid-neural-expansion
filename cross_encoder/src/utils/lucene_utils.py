    ...
    if _lucene_classes is None:
        try:
            ...
            _lucene_classes = {
                ...
                'MultiFieldQueryParser': autoclass('org.apache.lucene.queryparser.classic.MultiFieldQueryParser'),
                'ParseException': autoclass('org.apache.lucene.queryparser.classic.ParseException')
            }

...
class ColBERTIndexer(pt.Indexer):
    def __init__(self, checkpoint, index_root, index_name, chunksize, prepend_title=False, num_docs=None, ids=True, gpu=True, mask_punctuation=False, nbits=None, fp16=False):
        args = Object()
